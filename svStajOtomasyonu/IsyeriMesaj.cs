...
{
    public partial class IsyeriMesaj : Form
    {
        public IsyeriMesaj()
        {
            InitializeComponent();
            // This line of code is generated by Data Source Configuration Wizard
            mesajTableAdapter1.Fill(stajdbDataSetMesaj1.Mesaj);
        }
        SqlBaglanti baglan = new SqlBaglanti();
        String isim, id, mesaj, mesajKonu, mesajId,no;
        public int isyerimesajid;
        ...
        private void IsyeriMesaj_Load(object sender, EventArgs e)
        {
            SqlCommand komut2 = new SqlCommand("Select * from IsYeri where IsyeriId=@p1", baglan.baglanti());
            komut2.Parameters.AddWithValue("@p1", isyerimesajid);
            ...
            gridView1.Columns["aliciId"].FilterInfo = new ColumnFilterInfo("[aliciId]="+no);
        }
        ...
        private void gridView1_FocusedRowObjectChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowObjectChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                SqlCommand komut = new SqlCommand("Select * from Ogretmen where OgretmenTc=@p1", baglan.baglanti());
                ...
                while (read2.Read())
                {
                    isim = read2[3].ToString() + " " + read2[4].ToString();
                }
                textBox5.Text = isim;
